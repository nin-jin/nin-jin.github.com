...
var range= $jam.GM().aimNode( current )
...
var openEncoded= $jam.FZ.escape( open )
var closeEncoded= $jam.FZ.escape( close )
var Selector= arg.Selector || arg.encoder && factory.Selector( arg.encoder ) || factory.Selector()
var parse= $jam.GB( new function(){
...
$jam.FE
(   $jam.FQ( function( ){
return $jam.EU( factory.Selector( $jam.FY() ) )
})
,   function( proc ){
...
var Template= $jam.GO({ Selector: Selector })
...
var lineParser= $jam.FZ.build( '^((?:', oneIndent, ')*)(.*?)(?:', valSep, '(.*))?$' ).$
var parser=
function( str ){
...
(   50
,   function( target ){
$jam.FO().type( '$jam.GU' ).scream( target )
}
)
var handler=
function( event ){
...
var ratio= parseFloat( nodeRoot.attr( 'wc:EC' ) )
...
css.root= $lang.FX( 'lang:AZ' )
css.remark= $lang.FX( 'lang:BA' )
css.string= $lang.FX( 'lang:BG' )
css.bracket= $lang.FX( 'lang:BH' )
css.selector= $lang.FX( 'lang:BB' )
css.tag= $lang.FX( 'lang:BC' )
css.id= $lang.FX( 'lang:BD' )
css.klass= $lang.FX( 'lang:BE' )
css.pseudo= $lang.FX( 'lang:BF' )
css.property= $lang.FX( 'lang:BI' )
css.value= $lang.FX( 'lang:BJ' )
css.stylesheet=
$lang.GD( new function( ){
this[ /(\/\*[\s\S]*?\*\/)/.source ]=
$jam.FY( $lang.B, css.remark )
this[ /(\*|(?:\\[\s\S]|[\w-])+)/.source ]=
$jam.FY( $lang.B, css.tag )
this[ /(#(?:\\[\s\S]|[\w-])+)/.source ]=
$jam.FY( $lang.B, css.id )
this[ /(\.(?:\\[\s\S]|[\w-])+)/.source ]=
$jam.FY( $lang.B, css.klass )
this[ /(::?(?:\\[\s\S]|[\w-])+)/.source ]=
$jam.FY( $lang.B, css.pseudo )
this[ /\{([\s\S]+?)\}/.source ]=
new function( ){
...
$jam.FY( $lang.B, css.remark )
this[ /([\w-]+\s*:)/.source  ]=
$jam.FY( $lang.B, css.property )
this[ /([^:]+?(?:;|$))/.source ]=
$jam.FY( $lang.B, css.value )
})
return css
}
;$lang.D=
...
sgml.root= $lang.FX( 'lang:BK' )
sgml.tag= $lang.FX( 'lang:BL' )
sgml.tagBracket= $lang.FX( 'lang:ED' )
sgml.tagName= $lang.FX( 'lang:BM' )
sgml.attrName= $lang.FX( 'lang:BN' )
sgml.attrValue= $lang.FX( 'lang:BO' )
sgml.comment= $lang.FX( 'lang:BP' )
sgml.decl= $lang.FX( 'lang:BQ' )
sgml.tag=
$jam.FY
(   $lang.GD( new function(){
this[ /^(<\/?)([a-zA-Z][\w:-]*)/.source ]=
function( bracket, tagName ){
return sgml.tagBracket( $lang.B( bracket ) ) + sgml.tagName( tagName )
} 
this[ /(\s)([sS][tT][yY][lL][eE])(\s*=\s*)(")([\s\S]*?)(")/.source ]=
this[ /(\s)([sS][tT][yY][lL][eE])(\s*=\s*)(')([\s\S]*?)(')/.source ]=
function( prefix, name, sep, open, value, close ){
name= sgml.attrName( name )
value= sgml.attrValue( open + $lang.AZ.style( value ) + close )
...
function( prefix, name, sep, open, value, close ){
name= sgml.attrName( name )
value= sgml.attrValue( open + $lang.H( value ) + close )
return prefix + name + sep + value
}
...
$lang.GD( new function(){
this[ /(<!--[\s\S]*?-->)/.source ]=
$jam.FY( $lang.B, sgml.comment )
this[ /(<![\s\S]*?>)/.source ]=
$jam.FY( $lang.B, sgml.decl )
this[ /(<[sS][tT][yY][lL][eE][^>]*>)([\s\S]+?)(<\/[sS][tT][yY][lL][eE]>)/.source ]=
function( prefix, content, postfix ){
prefix= $lang.BK.tag( prefix )
postfix= $lang.BK.tag( postfix )
content= $lang.AZ( content )
return prefix + content + postfix
}
...
nodeRoot.clear()
var nodeResult=
$jam.FL.Element( 'wc:BR' )
.parent( nodeRoot )
var nodeSource0=
$jam.FL.Element( 'wc:BS' )
.parent( nodeRoot )
var nodeSource=
$jam.FL.parse( '<wc:AE wc:AF="sgml" />' )
.text( source )
.parent( nodeSource0 )
var exec= $jam.FR( function( ){
var source= $jam.FS( nodeSource.text() ).minimizeIndent().trim( /[\n\r]/ )
...
php.root= $lang.FX( 'lang:EE' )
php.dollar= $lang.FX( 'lang:BT' )
php.variable= $lang.FX( 'lang:BU' )
php.string= $lang.FX( 'lang:BV' )
php.number= $lang.FX( 'lang:BY' )
php.func= $lang.FX( 'lang:BW' )
php.keyword= $lang.FX( 'lang:BX' )
php.content=
$lang.GD( new function(){
...
this[ /('(?:[^\n'\\]*(?:\\\\|\\[^\\]))*[^\n'\\]*')/.source ]=
this[ /("(?:[^\n"\\]*(?:\\\\|\\[^\\]))*[^\n"\\]*")/.source ]=
$jam.FY( $lang.B, php.string )
this[ /((?:\d*\.)?\d(?:[eE])?)/.source ]=
$jam.FY( $lang.B, php.number )
})
return php
}
;$jam.EW
...
tags.root= $lang.FX( 'lang:EF' )
tags.item= $lang.FX( 'lang:EG' )
tags.content=
$lang.GD( new function(){
this[ /^(\s*?)([^\n\r]+)(\s*?)$/.source ]=
function( open, text, close ){
return open + '<a href="?gist/list/' + $jam.FW( text ) + '">' + tags.item( text ) + '</a>' + close
}
})
return tags
}
...
md.root= $lang.FX( 'lang:BZ' )
md.header1= $lang.FX( 'lang:CP' )
md.header2= $lang.FX( 'lang:CO' )
md.header3= $lang.FX( 'lang:CN' )
md.header4= $lang.FX( 'lang:EH' )
md.header5= $lang.FX( 'lang:EI' )
md.header6= $lang.FX( 'lang:EJ' )
md.headerMarker= $lang.FX( 'lang:CQ' )
md.quote= $lang.FX( 'lang:CR' )
md.quoteMarker= $lang.FX( 'lang:CS' )
md.quoteInline= $lang.FX( 'lang:CT' )
md.quoteInlineMarker= $lang.FX( 'lang:CU' )
md.image= $lang.FX( 'lang:CE' )
md.imageHref= $lang.FX( 'lang:CF' )
md.embed= $lang.FX( 'lang:CA' )
md.embedHref= $lang.FX( 'lang:CB' )
md.link= $lang.FX( 'lang:CG' )
md.linkMarker= $lang.FX( 'lang:CJ' )
md.linkTitle= $lang.FX( 'lang:CH' )
md.linkHref= $lang.FX( 'lang:CI' )
md.author= $lang.FX( 'lang:CK' )
md.indent= $lang.FX( 'lang:CL' )
md.escapingMarker= $lang.FX( 'lang:DF' )
md.emphasis= $lang.FX( 'lang:DG' )
md.emphasisMarker= $lang.FX( 'lang:DH' )
md.strong= $lang.FX( 'lang:DI' )
md.strongMarker= $lang.FX( 'lang:DJ' )
md.super= $lang.FX( 'lang:DK' )
md.superMarker= $lang.FX( 'lang:DL' )
md.sub= $lang.FX( 'lang:DM' )
md.subMarker= $lang.FX( 'lang:DN' )
md.math= $lang.FX( 'lang:CV' )
md.remark= $lang.FX( 'lang:DO' )
md.table= $lang.FX( 'lang:CW' )
md.tableRow= $lang.FX( 'lang:CX' )
md.tableCell= $lang.FX( 'lang:CZ' )
md.tableMarker= $lang.FX( 'lang:DA' )
md.code= $lang.FX( 'lang:DB' )
md.codeMarker= $lang.FX( 'lang:DC' )
md.codeLang= $lang.FX( 'lang:DD' )
md.codeContent= $lang.FX( 'lang:DE' )
md.html= $lang.FX( 'lang:EK' )
md.htmlTag= $lang.FX( 'lang:EL' )
md.htmlContent= $lang.FX( 'lang:EM' )
md.para= $lang.FX( 'lang:CM' )
md.inline=
$lang.GD( new function(){
// indentation
// ^\s+
...
return md.link( '<a href="' + $jam.FW( uri ) + '">' + open + title + middle + href + close + '</a>' )
}
// image
// [url]
this[ /(\[)([^\[\]]+)(\])/.source ]=
function( open, href, close ){
return md.image( md.imageHref( open + href + close ) + '<a href="' + $jam.FW( href ) + '"><object data="' + $jam.FW( href ) + '"></object></a>' )
}
// emphasis
// /some text/
this[ /([^\s"({[]\/)/.source ]=
...
var embed= md.embed( '<wc:AT wc:EC=".75"><iframe class="wc_lang_md_embed-object" src="' + uri + '" allowfullscreen></iframe></wc:AT>' )
return href + embed
}
// image
...
var embed= md.embed( '<a href="' + $jam.FW( url ) + '"><image src="' + $jam.FW( url ) + '" /></a>' )
return href + embed
}
// table
// --
...
row= cells.join( '' )
var rowSep= '<lang:CY><wc:EN colspan="300">\n--</wc:EN></lang:CY>'
...
var thread= nodeRoot.html( $lang.BZ( '  0 *a* b' ) )
...
return new function( ){
nodeRoot= $jam.FL( nodeRoot )
var source= $jam.FW( nodeRoot.text() ).replace( /\r?\n/g, '<br />' )
nodeRoot.clear()
var nodeSource= $jam.FL.parse( '<div class=" wc_editor_content " />' )
.html( source )
.parent( nodeRoot )
var sourceLast= ''
var update= $jam.GP( 50, function( ){
//var source= $jam.FS( nodeSource.text() ).replace( /\n?\r?$/, '\n' ).$
var source= nodeSource.text()
if( source === sourceLast ) return
sourceLast= source
source=
$jam.FS( source )
.process( $lang( nodeRoot.attr( 'wc:AF' ) ) )
.replace( /  /g, '\u00A0 ' )
.replace( /  /g, ' \u00A0' )
//.replace( /[^\n<>](?:<[^<>]+>)*$/, '$&\n' )
.replace( /$/, '\n' )
.replace( /\n/g, '<br/>' )
.$
var nodeRange= $jam.GM().aimNodeContent( nodeSource )
var startPoint= $jam.GM().collapse2start()
//console.log(nodeRange.html())
var endPoint= $jam.GM().collapse2end()
...
//if( !source ) $jam.GM().aimNode( nodeSource.head() ).collapse2end().select()
...
event.defaultBehavior( false )
$jam.GM().html( '<br/>' ).collapse2end().select()
})
var onAltSymbol=
...
if( !symbol ) return
event.defaultBehavior( false )
$jam.GM().text( symbol ).collapse2end().select()
})
//var onBackspace=
//nodeRoot.listen( 'keydown', function( event ){
//    event= $jam.FO( event )
...
//    if( event.keyAccel() ) return
//    event.defaultBehavior( false )
//    var fullRange= $jam.GM().aimNodeContent( nodeSource )
//    var newOffset= fullRange.clone().equalize( 'end2start', $jam.GM() ).text().length - 1
//    if( newOffset < 0 ) newOffset= 0
//    var range= fullRange.clone().move( newOffset ).equalize( 'end2end', $jam.GM() )
//    range.dropContents()
//})
var onTab=
nodeRoot.listen( 'keydown', function( event ){
...
if( event.keyAccel() ) return
event.defaultBehavior( false )
$jam.GM().text( '    ' ).collapse2end().select()
})
var onLeave=
nodeSource.listen( 'blur', function( event ){
$jam.FO().type( '$jam.FT' ).scream( nodeRoot )
})
var onActivate=
nodeRoot.listen( 'mousedown', function( event ){
event= $jam.FO( event )
if( !event.keyMeta() ) return
nodeRoot.attr( 'wc:CC', true )
...
;$jam.GH( 'https://github.com/nin-jin/wc' )
;$jam.FC
(   'wc:DX'
,   function( nodeRoot ){
nodeRoot=
...
;$jam.GH( 'https://github.com/nin-jin/doc' )
