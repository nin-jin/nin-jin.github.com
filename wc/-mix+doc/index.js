...
var openEncoded= $jam.FY.escape( open )
var closeEncoded= $jam.FY.escape( close )
var Selector= arg.Selector || arg.encoder && factory.Selector( arg.encoder ) || factory.Selector()
var parse= $jam.GA( new function(){
...
$jam.FE
(   $jam.FR( function( ){
return $jam.EU( factory.Selector( $jam.FX() ) )
})
,   function( proc ){
...
var Template= $jam.GS({ Selector: Selector })
...
var lineParser= $jam.FY.build( '^((?:', oneIndent, ')*)(.*?)(?:', valSep, '(.*))?$' ).$
var parser=
function( str ){
...
lastURI= newURI
$jam.FO().type( '$jam.GX' ).scream( $jam.EX() )
}
...
;$jam.GN( 'https://github.com/nin-jin/doc' )
